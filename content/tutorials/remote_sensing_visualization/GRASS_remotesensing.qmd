...
![Distribution of pixel values after histogram equalization](img_remotesensing/landsat_b5eq_histogram.webp){width="80%"}
...
![Landsat band 5 after histogram equalization](img_remotesensing/remotesensing_13.webp){width="80%"}
...
![Natural color image from fusion of Landsat bands 4, 3, & 2](img_remotesensing/remotesensing_20.webp){width="80%"}
...
![NDVI map shading a relief map of DEM topography](img_remotesensing/remotesensing_25.webp){width="80%"}
...
![Image fusion of PCA components 1, 2, & 3 overlayed by streams and lakes vectors](img_remotesensing/PCA123_streams_lakes.webp){width="80%"}
...
![Relief map of topography shaded by RGB fusion of PCA components 1-3](img_remotesensing/PCA123_relief.webp){width="80%"}
...
:::{.smaller}
*© Michael Barton 2026*
*The development of this tutorial was funded in part by the US [National Science Foundation (NSF)](https://www.nsf.gov/), award [2303651](https://www.nsf.gov/awardsearch/showAward?AWD_ID=2303651).*
:::
